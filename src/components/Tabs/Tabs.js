...
const Tabs = ({ activeTabName, onClickTab }) => {
  ...
  const renderTabTilte = (tabTitle, isActive, icon, id) => (
    <div
  ...
  return (
    <>
      {/* Rendering the icon of three tabs  */}
      ...
      {activeTabName === CANCEL_AT_ANY_TIME && (
       ...
       {/* Rending the second tab content  */}
          ...
          <div className="container">
            ...
            >
              <div className="tab-2-content-top">
                <p className="text-lg">
                  Watch TV shows and movies ,anywhere- Pensonalized for you.
                </p>
                <Link to="/netflix-show" className="btn btn-lg">
                  Watch Free For 30 days
                </Link>
    ...
    {/* Rendering the third tab content  */}
    {
     activeTabName===PICK_YOUR_PRICE && (
        <section className="tab-content">
        <div className="container">
